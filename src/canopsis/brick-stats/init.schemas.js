...
window.bricks['brick-stats'].schemasArray = ["text!canopsis/brick-stats/schemas/widget.statstable.json"];

define(window.bricks['brick-stats'].schemasArray, function () {
    for (var i = 0; i < arguments.length; i++) {
        var schemaName = window.bricks['brick-stats'].schemasArray[i];
        var urlPrefix = 'canopsis/brick-stats/schemas/';
