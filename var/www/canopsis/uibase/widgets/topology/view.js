                ...
                */
                updateModel: function() {
                    ...
                    */
                    ...
                    ['nodes', 'links'].forEach(
                        function(type) {
                            var indexToDelete = arrayToDelete[type];
                            var count = 0;
                ...
                */
                ...
                addHandler: function(data) {
                    ...
                    if (this.source === null) { // in case of node
                        controller.newRecord(controller.verticeEltType, undefined, true, callback, undefined, this);
                ...
                */
                addLink: function(source, target, edit, success, failure, context) {
                    ...
                    if (sourceType === 'edge') {
                        ...
                        var record = controller.graphModel.recordsById[result.id];
