...
Ember.Application.initializer({
    name:"JobForm",
    after: ['FormController', 'FormsUtils', 'HashUtils', 'DataUtils', 'SchemasRegistry'],
    initialize: function(container, application) {
        var FormController = container.lookupFactory('controller:form');
        var formsUtils = container.lookupFactory('utility:form');
        var dataUtils = container.lookupFactory('utility:data');
        var hashUtils = container.lookupFactory('utility:form');
        ...
        var form = FormController.extend({
