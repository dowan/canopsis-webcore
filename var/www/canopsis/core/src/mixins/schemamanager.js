...
Ember.Application.initializer({
    ...
    after: ['Schemas', 'MixinFactory', 'FormsUtils', 'DataUtils', 'SearchmethodsRegistry'],
    initialize: function(container, application) {
        var schemasLoader = container.lookupFactory('loader:schemas');
        ...
        var mixin = Mixin('schemamanager', {
            configuration: window.canopsisConfiguration,
