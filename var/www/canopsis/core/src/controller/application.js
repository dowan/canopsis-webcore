...
Ember.Application.initializer({
    ...
    initialize: function(container, application) {
        ...
        var actionsRegistry = container.lookupFactory('registry:actions');
        var mixinsRegistry = container.lookupFactory('registry:mixins');
        var inflectionsRegistry = container.lookupFactory('registry:inflections');
        ...
        var ApplicationControllerDict = {
             ...
             */
            runtimeConfiguration: window.canopsisConfiguration,
            ...
            init: function() {
                ...
                //Set page title
                var title = get(window.canopsisConfiguration, 'TITLE');
                if (!isNone(title)) {
                    $('title').html(title);
                }
