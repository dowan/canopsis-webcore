...
Ember.Application.initializer({
    name:"FormsUtils",
    after: ['UtilityClass', 'RoutesUtils', 'DataUtils', 'FormsRegistry'],
    initialize: function(container, application) {
        ...
        var formUtils = Utility.create({
            ...
            instantiateForm: function(formName, formContext, options) {
                ...
                var formClass = dataUtils.getEmberApplicationSingleton().__container__.lookupFactory('form:' + formName.dasherize().substring(0, formName.length - 4));
                ...
                var formController = formClass.create(classDict);
