...
Ember.Application.initializer({
    name:'ModelForm',
    after: ['FormController', 'SchemasRegistry', 'InspectableItemMixin', 'ValidationMixin', 'SlugUtils'],
    initialize: function(container, application) {
        var FormController = container.lookupFactory('controller:form');
        var schemasRegistry = container.lookupFactory('registry:schema');
         ...
         */
        var form = FormController.extend(InspectableitemMixin, ValidationMixin, {
            needs: ['application'],
